		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#testefiorierick-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testefiorierick-display": {
								"semanticObject": "testefiorierick",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testefiorierick",
									"url": sap.ui.require.toUrl("testefiorierick")
								}
							}
						}
					}
